-- Recreate make_workspace_enterprise function to recognize pgcrypto functions
DROP FUNCTION IF EXISTS public.make_workspace_enterprise(uuid);
...
BEGIN
  ...
  -- Generate API key using pgcrypto extension
