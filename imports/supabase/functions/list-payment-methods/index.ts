...
serve(async (req) => {
  ...
  try {
    ...
    logStep("Payment methods retrieved", { count: paymentMethods.data.length });

    // Get customer to find default payment method
    const customer = await stripe.customers.retrieve(customerId);
    const defaultPaymentMethodId = typeof customer !== 'deleted' ? customer.invoice_settings.default_payment_method : null;
