...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-6 w-full items-center justify-between rounded-[6px] border border-rc-border bg-muted/30 px-2 text-xs ring-offset-background placeholder:text-muted-foreground",
      "shadow-subtle",
