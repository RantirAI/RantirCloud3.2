...
const sheetVariants = cva(
  "fixed z-50 gap-0 bg-background shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      side: {
...
const SheetHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left bg-gray-100 px-4 py-2 border-b text-gray-900",
      className
    )}
    {...props}
  />
...
export {
  Sheet, SheetClose,
  SheetContent, SheetContentInner, SheetDescription, SheetFooter, SheetHeader, SheetOverlay, SheetPortal, SheetTitle, SheetTrigger
}
