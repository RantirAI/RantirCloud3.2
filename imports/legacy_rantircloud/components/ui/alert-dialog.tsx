...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-center sm:text-left bg-gray-100 px-6 py-4 border-b text-gray-900 rounded-t-lg",
      className
    )}
    {...props}
  />
...
AlertDialogContentInner.displayName = "AlertDialogContentInner"
