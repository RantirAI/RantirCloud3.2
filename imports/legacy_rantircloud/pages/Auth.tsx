...
import { Sparkles, Database, Workflow, Cloud } from "lucide-react";
        ...
        <div className="w-full max-w-md p-6 bg-card rounded-xl shadow-sm border">
          <div className="flex flex-col items-center mb-6">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Log into Rantir Cloud to manage your data and integrations
            </p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            <div className="text-center text-sm">
              ...
              <button type="button" className="text-primary hover:underline" onClick={() => navigate("/onboarding")}>
                Sign up
              </button>
            </div>
          </form>
