/**
 * Rantir Published Apps Router (JavaScript version for Cloudflare Dashboard)
 * 
 * Copy this entire file into the Cloudflare Worker editor.
 * Add environment variable: SUPABASE_URL = https://appdmmjexevclmpyvtss.supabase.co
 */
...
async function getRoutingInfo(hostname, env) {
...
function buildRenderUrl(supabaseUrl, routingInfo, originalUrl) {
