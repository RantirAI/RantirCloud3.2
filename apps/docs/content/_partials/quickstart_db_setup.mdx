...
When your project is up and running, go to the [Table Editor](/dashboard/project/_/editor), create a new table and insert some data. Ensure the **Enable Data API Access** toggle is on.
