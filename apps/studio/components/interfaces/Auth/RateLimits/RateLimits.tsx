  ...
  return (
    <>
      <PageSection>
        <PageSectionMeta>
          <PageSectionSummary>
            <PageSectionTitle>Rate Limits</PageSectionTitle>
            <PageSectionDescription>Control how frequently authentication-related actions can be performed in your project.</PageSectionDescription>
          </PageSectionSummary>
        </PageSectionMeta>
        <PageSectionContent>
                ...
                <CardContent>
                  <FormField_Shadcn_
                    ...
                    render={({ field }) => (
                      <FormItemLayout
                        layout="flex-row-reverse"
                        label="Anonymous user sign-ins"
                        description="Number of anonymous user sign-ins that can be made per hour per IP address"
                      >
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <FormControl_Shadcn_>
                ...
                <CardContent>
                  <FormField_Shadcn_
                    ...
                    render={({ field }) => (
                      <FormItemLayout
                        layout="flex-row-reverse"
                        label="Web3 sign-ups and sign-ins"
