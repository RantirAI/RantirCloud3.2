...
import { SheetHeader, SheetTitle, Tabs_Shadcn_, TabsContent_Shadcn_, TabsList_Shadcn_, TabsTrigger_Shadcn_ } from 'ui'
...
export function OrgSelectorSheet({
  ...
  return (
    ...
    >
      <Tabs_Shadcn_ defaultValue="organization" className="flex flex-col flex-1 min-h-0 overflow-hidden p-0">
        <SheetHeader className="border-0 border-default p-0 shrink-0">
          ...
          <TabsList_Shadcn_ className="w-full grid grid-cols-1 shrink-0">
            <TabsTrigger_Shadcn_
              value="organization"
              className="text-xs flex flex-col items-center gap-1.5 px-4 py-3 data-[state=active]:bg-surface-200 data-[state=active]:border-foreground-light border-b"
            >
